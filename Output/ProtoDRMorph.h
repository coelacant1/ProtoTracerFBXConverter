...
private:
    ...
    VertexGroup basisIndexes[84] = {VertexGroup(2,1,0),VertexGroup(3,1,2),VertexGroup(3,4,1),VertexGroup(4,5,1),VertexGroup(4,6,5),VertexGroup(6,7,5),VertexGroup(9,8,7),VertexGroup(9,7,6),VertexGroup(9,10,8),VertexGroup(10,11,8),VertexGroup(10,12,11),VertexGroup(10,13,12),VertexGroup(14,15,16),VertexGroup(15,17,16),VertexGroup(18,19,20),VertexGroup(19,21,20),VertexGroup(24,23,22),VertexGroup(22,25,24),VertexGroup(26,27,28),VertexGroup(28,29,26),VertexGroup(28,30,29),VertexGroup(30,31,29),VertexGroup(30,32,31),VertexGroup(32,33,31),VertexGroup(32,34,33),VertexGroup(32,35,34),VertexGroup(38,37,36),VertexGroup(38,39,37),VertexGroup(38,40,39),VertexGroup(38,41,40),VertexGroup(44,43,42),VertexGroup(44,45,43),VertexGroup(45,46,43),VertexGroup(46,47,43),VertexGroup(48,49,50),VertexGroup(49,51,50),VertexGroup(50,51,52),VertexGroup(52,53,50),VertexGroup(54,55,56),VertexGroup(57,54,56),VertexGroup(58,54,57),VertexGroup(54,58,59),VertexGroup(62,61,60),VertexGroup(63,61,62),VertexGroup(63,64,61),VertexGroup(64,65,61),VertexGroup(68,67,66),VertexGroup(68,69,67),VertexGroup(72,71,70),VertexGroup(72,73,71),VertexGroup(72,74,73),VertexGroup(72,75,74),VertexGroup(78,77,76),VertexGroup(76,79,78),VertexGroup(79,80,78),VertexGroup(79,81,80),VertexGroup(84,83,82),VertexGroup(84,85,83),VertexGroup(86,83,85),VertexGroup(86,87,83),VertexGroup(90,89,88),VertexGroup(90,91,89),VertexGroup(90,92,91),VertexGroup(90,93,92),VertexGroup(96,95,94),VertexGroup(96,97,95),VertexGroup(97,98,95),VertexGroup(95,98,99),VertexGroup(102,101,100),VertexGroup(102,103,101),VertexGroup(102,104,103),VertexGroup(102,105,104),VertexGroup(106,107,108),VertexGroup(108,109,106),VertexGroup(108,110,109),VertexGroup(108,111,110),VertexGroup(112,113,114),VertexGroup(114,115,112),VertexGroup(118,117,116),VertexGroup(116,119,118),VertexGroup(120,121,122),VertexGroup(121,123,122),VertexGroup(124,125,126),VertexGroup(126,127,124)};
